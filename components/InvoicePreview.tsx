...
const InvoicePreview: React.FC<PreviewProps> = ({ data }) => {
  ...
  const formatCurrency = (val: number) => {
    return `${details.currencySymbol}${val.toLocaleString(undefined, {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-12">
        <div className="space-y-4 max-w-[50%]">
          {business.logo ? (
            ...
            <div className="w-16 h-16 bg-gray-100 rounded flex items-center justify-center border-2 border-dashed border-gray-300 text-gray-400 text-xs">
              Logo
            </div>
          )}
        ...
        <div className="text-right space-y-2">
          <h2 className="text-4xl font-black text-gray-900 uppercase tracking-widest">
      ...
      {/* Bill To */}
      <div className="flex justify-end mb-12 -mt-10">
      ...
      <table className="w-full mb-12">
        <thead>
          <tr
            ...
            style={{ borderColor: business.brandColor }}
          >
            <th className="text-left py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">
              Description
            </th>
            <th className="text-center py-3 text-xs font-bold text-gray-400 uppercase tracking-wider w-24">
              Qty
            </th>
            <th className="text-right py-3 text-xs font-bold text-gray-400 uppercase tracking-wider w-32">
              Price
            </th>
            <th className="text-right py-3 text-xs font-bold text-gray-400 uppercase tracking-wider w-32">
              Total
        ...
        <div className="flex flex-col items-end justify-end">
          <div className="w-48 text-center">
            {footer.signatureType === "text" && footer.signatureText && (
              <p
                className="signature-font text-3xl border-b border-gray-300 pb-2 mb-2"
                style={{ color: business.brandColor }}
              >
            ...
            {footer.signatureType === "image" && footer.signatureImage && (
              <img
                src={footer.signatureImage}
                alt="Signature"
                className="max-h-16 mx-auto mb-2 border-b border-gray-300"
              />
            )}
